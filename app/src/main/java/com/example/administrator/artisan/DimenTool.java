...
public class DimenTool {
    public static void gen() {
        ...
        File file = new File("D:/Demos1/Artisan/app/src/main/res/values/dimens.xml");
        ...
        try {
            ...
            reader.close();
            System.out.println("{C}<!--  sw480 -->");
            System.out.println(sw480);
            System.out.println("{C}<!--  sw600 -->");
            System.out.println(sw600);

            System.out.println("{C}<!--  sw720 -->");
            System.out.println(sw720);
            System.out.println("{C}<!--  sw800 -->");
